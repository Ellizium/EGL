...
namespace EGL.GodotBase.Utility
{
    public class Viewport : INode
    {
        ...
        public event Action<Godot.Control> GuiFocusChanged;
        public event Action<Godot.Vector2> SizeChanged;

        public Godot.Node Base { get; }
        ...
        protected class _Viewport : Godot.Viewport
        {
            public Viewport ClassOwner;

            public _Viewport(Viewport node)
            {
                ClassOwner = node;
                ...
                Connect("gui_focus_changed", this, nameof(GuiFocusChanged));
                Connect("size_changed", this, nameof(SizeChanged));
            }
            ...
            private void SizeChanged()
                => ClassOwner.SizeChanged?.Invoke(Size);
        }
    }
}

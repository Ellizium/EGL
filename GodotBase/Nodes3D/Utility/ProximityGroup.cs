...
{
    public class ProximityGroup : INode
    {
        ...
        public Godot.ProximityGroup Base { get; }

        public ProximityGroup()
        {
            Base = new _ProximityGroup(this);
        }

        protected class _ProximityGroup : Godot.ProximityGroup
        {
            public ProximityGroup ClassOwner;

            public _ProximityGroup(ProximityGroup node)
            {
                ClassOwner = node;
                ...
                //ProximityGroup
                Connect("broadcast", this, nameof(Broadcast));
            }
            ...
            #region ProximityGroup
            private void Broadcast(string str, object[] obj)
            {
                ClassOwner.Broadcast?.Invoke(str, obj);
            }
            #endregion
        }
    }

...
{
    public class RemoteTransform : INode
    {
        ...
        public Godot.RemoteTransform Base { get; }

        public RemoteTransform()
        {
            Base = new _RemoteTransform(this);
        }

        protected class _RemoteTransform : Godot.RemoteTransform
        {
            public RemoteTransform ClassOwner;

            public _RemoteTransform(RemoteTransform node)
            {
                ClassOwner = node;

...
{
    public class VisibilityEnabler : INode
    {
        ...
        public Godot.VisibilityEnabler Base { get; }

        public VisibilityEnabler()
        {
            Base = new _VisibilityEnabler(this);
        }

        protected class _VisibilityEnabler : Godot.VisibilityEnabler
        {
            public VisibilityEnabler ClassOwner;

            public _VisibilityEnabler(VisibilityEnabler node)
            {
                ClassOwner = node;

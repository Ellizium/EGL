...
namespace EGL.GodotBase.Nodes3D.Audio
{
    public class AudioStreamPlayer3D : INode
    {
        ...
        public Godot.AudioStreamPlayer3D Base { get; }

        public AudioStreamPlayer3D()
        {
            Base = new _AudioStreamPlayer3D(this);
        }

        protected class _AudioStreamPlayer3D : Godot.AudioStreamPlayer3D
        {
            public AudioStreamPlayer3D ClassOwner;

            public _AudioStreamPlayer3D(AudioStreamPlayer3D node)
            {
                ClassOwner = node;
            ...
            #region AudioStreamPlayer3D
            private void Finished()
            {
                ClassOwner.Finished?.Invoke();
            }
            #endregion
        }
    }

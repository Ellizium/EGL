...
namespace EGL.GodotBase.Nodes3D.Cameras
{
    public class InterpolatedCamera : INode
    {
        ...
        public Godot.InterpolatedCamera Base { get; }

        public InterpolatedCamera()
        {
            Base = new _InterpolatedCamera(this);
        }

        protected class _InterpolatedCamera : Godot.InterpolatedCamera
        {
            public InterpolatedCamera ClassOwner;

            public _InterpolatedCamera(InterpolatedCamera node)
            {
                ClassOwner = node;

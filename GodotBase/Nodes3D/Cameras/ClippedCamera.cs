...
{
    public class ClippedCamera : INode
    {
        ...
        public Godot.ClippedCamera Base { get; }

        public ClippedCamera()
        {
            Base = new _ClippedCamera(this);
        }

        protected class _ClippedCamera : Godot.ClippedCamera
        {
            public ClippedCamera ClassOwner;

            public _ClippedCamera(ClippedCamera node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.Nodes3D
{
    public class Spatial : INode
    {
        ...
        protected class _Spatial : Godot.Spatial
        {
            public Spatial ClassOwner;

            public _Spatial(Spatial node)
            {
                ClassOwner = node;

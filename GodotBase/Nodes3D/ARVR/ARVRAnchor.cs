...
namespace EGL.GodotBase.Nodes3D.ARVR
{
    public class ARVRAnchor : INode
    {
        ...
        public Godot.ARVRAnchor Base { get; }

        public ARVRAnchor()
        {
            Base = new _ARVRAnchor(this);
        }

        protected class _ARVRAnchor : Godot.ARVRAnchor
        {
            public ARVRAnchor ClassOwner;

            public _ARVRAnchor(ARVRAnchor node)
            {
                ClassOwner = node;

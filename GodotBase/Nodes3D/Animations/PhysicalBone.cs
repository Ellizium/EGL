...
{
    public class PhysicalBone : INode
    {
        ...
        public Godot.PhysicalBone Base { get; }

        public PhysicalBone()
        {
            Base = new _PhysicalBone(this);
        }

        protected class _PhysicalBone : Godot.PhysicalBone
        {
            public PhysicalBone ClassOwner;

            public _PhysicalBone(PhysicalBone node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.Nodes3D.Animations
{
    public class BoneAttachment : INode
    {
        ...
        public Godot.BoneAttachment Base { get; }

        public BoneAttachment()
        {
            Base = new _BoneAttachment(this);
        }

        protected class _BoneAttachment : Godot.BoneAttachment
        {
            public BoneAttachment ClassOwner;

            public _BoneAttachment(BoneAttachment node)
            {
                ClassOwner = node;

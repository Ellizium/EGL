...
namespace EGL.GodotBase.Nodes3D.Animations
{
    public class Skeleton : INode
    {
        ...
        public Godot.Skeleton Base { get; }

        public Skeleton()
        {
            Base = new _Skeleton(this);
        }

        protected class _Skeleton : Godot.Skeleton
        {
            public Skeleton ClassOwner;

            public _Skeleton(Skeleton node)
            {
                ClassOwner = node;

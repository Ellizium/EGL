...
{
    public class ImmediateGeometry : INode
    {
        ...
        public Godot.ImmediateGeometry Base { get; }

        public ImmediateGeometry()
        {
            Base = new _ImmediateGeometry(this);
        }

        protected class _ImmediateGeometry : Godot.ImmediateGeometry
        {
            public ImmediateGeometry ClassOwner;

            public _ImmediateGeometry(ImmediateGeometry node)
            {
                ClassOwner = node;

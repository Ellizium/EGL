...
{
    public class AnimatedSprite3D : INode
    {
        ...
        public Godot.AnimatedSprite3D Base { get; }

        public AnimatedSprite3D()
        {
            Base = new _AnimatedSprite3D(this);
        }

        protected class _AnimatedSprite3D : Godot.AnimatedSprite3D
        {
            public AnimatedSprite3D ClassOwner;

            public _AnimatedSprite3D(AnimatedSprite3D node)
            {
                ClassOwner = node;
            ...
            #region AnimatedSprite3D
            private void FrameChanged()
            {
                ClassOwner.FrameChanged?.Invoke();
            }
            #endregion
        }
    }

...
namespace EGL.GodotBase.Nodes3D.Render.Visual
{
    public class Particles : INode
    {
        ...
        public Godot.Particles Base { get; }

        public Particles()
        {
            Base = new _Particles(this);
        }

        protected class _Particles : Godot.Particles
        {
            public Particles ClassOwner;

            public _Particles(Particles node)
            {
                ClassOwner = node;

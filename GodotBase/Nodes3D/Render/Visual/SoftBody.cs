...
namespace EGL.GodotBase.Nodes3D.Render.Visual
{
    public class SoftBody : INode
    {
        ...
        public Godot.SoftBody Base { get; }

        public SoftBody()
        {
            Base = new _SoftBody(this);
        }

        protected class _SoftBody : Godot.SoftBody
        {
            public SoftBody ClassOwner;

            public _SoftBody(SoftBody node)
            {
                ClassOwner = node;

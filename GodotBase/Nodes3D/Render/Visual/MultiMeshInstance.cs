...
{
    public class MultiMeshInstance : INode
    {
        ...
        public Godot.MultiMeshInstance Base { get; }

        public MultiMeshInstance()
        {
            Base = new _MultiMeshInstance(this);
        }

        protected class _MultiMeshInstance : Godot.MultiMeshInstance
        {
            public MultiMeshInstance ClassOwner;

            public _MultiMeshInstance(MultiMeshInstance node)
            {
                ClassOwner = node;

...
{
    public class MeshInstance : INode
    {
        ...
        public Godot.MeshInstance Base { get; }

        public MeshInstance()
        {
            Base = new _MeshInstance(this);
        }

        protected class _MeshInstance : Godot.MeshInstance
        {
            public MeshInstance ClassOwner;

            public _MeshInstance(MeshInstance node)
            {
                ClassOwner = node;

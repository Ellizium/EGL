...
{
    public class CPUParticles : INode
    {
        ...
        public Godot.CPUParticles Base { get; }

        public CPUParticles()
        {
            Base = new _CPUParticles(this);
        }

        protected class _CPUParticles : Godot.CPUParticles
        {
            public CPUParticles ClassOwner;

            public _CPUParticles(CPUParticles node)
            {
                ClassOwner = node;

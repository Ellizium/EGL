...
namespace EGL.GodotBase.Nodes3D.Render.Visual
{
    public class Sprite3D : INode
    {
        ...
        public Godot.Sprite3D Base { get; }

        public Sprite3D()
        {
            Base = new _Sprite3D(this);
        }

        protected class _Sprite3D : Godot.Sprite3D
        {
            public Sprite3D ClassOwner;

            public _Sprite3D(Sprite3D node)
            {
                ClassOwner = node;

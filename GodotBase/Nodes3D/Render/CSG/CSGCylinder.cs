...
{
    public class CSGCylinder : INode
    {
        ...
        public Godot.CSGCylinder Base { get; }

        public CSGCylinder()
        {
            Base = new _CSGCylinder(this);
        }

        protected class _CSGCylinder : Godot.CSGCylinder
        {
            public CSGCylinder ClassOwner;

            public _CSGCylinder(CSGCylinder node)
            {
                ClassOwner = node;

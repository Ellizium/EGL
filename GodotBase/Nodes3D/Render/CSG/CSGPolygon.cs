...
namespace EGL.GodotBase.Nodes3D.Render.CSG
{
    public class CSGPolygon : INode
    {
        ...
        public Godot.CSGPolygon Base { get; }

        public CSGPolygon()
        {
            Base = new _CSGPolygon(this);
        }

        protected class _CSGPolygon : Godot.CSGPolygon
        {
            public CSGPolygon ClassOwner;

            public _CSGPolygon(CSGPolygon node)
            {
                ClassOwner = node;

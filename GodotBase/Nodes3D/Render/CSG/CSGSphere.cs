...
namespace EGL.GodotBase.Nodes3D.Render.CSG
{
    public class CSGSphere : INode
    {
        ...
        public Godot.CSGSphere Base { get; }

        public CSGSphere()
        {
            Base = new _CSGSphere(this);
        }

        protected class _CSGSphere : Godot.CSGSphere
        {
            public CSGSphere ClassOwner;

            public _CSGSphere(CSGSphere node)
            {
                ClassOwner = node;

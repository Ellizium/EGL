...
namespace EGL.GodotBase.Nodes3D.Render.CSG
{
    public class CSGTorus : INode
    {
        ...
        public Godot.CSGTorus Base { get; }

        public CSGTorus()
        {
            Base = new _CSGTorus(this);
        }

        protected class _CSGTorus : Godot.CSGTorus
        {
            public CSGTorus ClassOwner;

            public _CSGTorus(CSGTorus node)
            {
                ClassOwner = node;

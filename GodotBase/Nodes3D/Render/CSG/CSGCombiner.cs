...
namespace EGL.GodotBase.Nodes3D.Render.CSG
{
    public class CSGCombiner : INode
    {
        ...
        public Godot.CSGCombiner Base { get; }

        public CSGCombiner()
        {
            Base = new _CSGCombiner(this);
        }

        protected class _CSGCombiner : Godot.CSGCombiner
        {
            public CSGCombiner ClassOwner;

            public _CSGCombiner(CSGCombiner node)
            {
                ClassOwner = node;

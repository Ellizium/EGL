...
namespace EGL.GodotBase.Nodes3D.Render.Light
{
    public class DirectionalLight : INode
    {
        ...
        public Godot.DirectionalLight Base { get; }

        public DirectionalLight()
        {
            Base = new _DirectionalLight(this);
        }

        protected class _DirectionalLight : Godot.DirectionalLight
        {
            public DirectionalLight ClassOwner;

            public _DirectionalLight(DirectionalLight node)
            {
                ClassOwner = node;

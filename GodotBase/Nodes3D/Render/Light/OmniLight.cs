...
namespace EGL.GodotBase.Nodes3D.Render.Light
{
    public class OmniLight : INode
    {
        ...
        public Godot.OmniLight Base { get; }

        public OmniLight()
        {
            Base = new _OmniLight(this);
        }

        protected class _OmniLight : Godot.OmniLight
        {
            public OmniLight ClassOwner;

            public _OmniLight(OmniLight node)
            {
                ClassOwner = node;

...
{
    public class BakedLightmap : INode
    {
        ...
        public Godot.BakedLightmap Base { get; }

        public BakedLightmap()
        {
            Base = new _BakedLightmap(this);
        }

        protected class _BakedLightmap : Godot.BakedLightmap
        {
            public BakedLightmap ClassOwner;

            public _BakedLightmap(BakedLightmap node)
            {
                ClassOwner = node;

...
{
    public class ReflectionProbe : INode
    {
        ...
        public Godot.ReflectionProbe Base { get; }

        public ReflectionProbe()
        {
            Base = new _ReflectionProbe(this);
        }

        protected class _ReflectionProbe : Godot.ReflectionProbe
        {
            public ReflectionProbe ClassOwner;

            public _ReflectionProbe(ReflectionProbe node)
            {
                ClassOwner = node;

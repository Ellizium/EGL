...
namespace EGL.GodotBase.Nodes3D.Render.Light
{
    public class SpotLight : INode
    {
        ...
        public Godot.SpotLight Base { get; }

        public SpotLight()
        {
            Base = new _SpotLight(this);
        }

        protected class _SpotLight : Godot.SpotLight
        {
            public SpotLight ClassOwner;

            public _SpotLight(SpotLight node)
            {
                ClassOwner = node;

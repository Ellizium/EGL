...
namespace EGL.GodotBase.Nodes3D.Render.Light
{
    public class GIProbe : INode
    {
        ...
        public Godot.GIProbe Base { get; }

        public GIProbe()
        {
            Base = new _GIProbe(this);
        }

        protected class _GIProbe : Godot.GIProbe
        {
            public GIProbe ClassOwner;

            public _GIProbe(GIProbe node)
            {
                ClassOwner = node;

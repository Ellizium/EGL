...
{
    public class NavigationMeshInstance : INode
    {
        ...
        public Godot.NavigationMeshInstance Base { get; }

        public NavigationMeshInstance()
        {
            Base = new _NavigationMeshInstance(this);
        }

        protected class _NavigationMeshInstance : Godot.NavigationMeshInstance
        {
            public NavigationMeshInstance ClassOwner;

            public _NavigationMeshInstance(NavigationMeshInstance node)
            {
                ClassOwner = node;

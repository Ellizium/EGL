...
namespace EGL.GodotBase.Nodes3D.Navigations
{
    public class PathFollow : INode
    {
        ...
        public Godot.PathFollow Base { get; }

        public PathFollow()
        {
            Base = new _PathFollow(this);
        }

        protected class _PathFollow : Godot.PathFollow
        {
            public PathFollow ClassOwner;

            public _PathFollow(PathFollow node)
            {
                ClassOwner = node;

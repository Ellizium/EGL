...
namespace EGL.GodotBase.Nodes3D.Navigations
{
    public class Navigation : INode
    {
        ...
        public Godot.Navigation Base { get; }

        public Navigation()
        {
            Base = new _Navigation(this);
        }

        protected class _Navigation : Godot.Navigation
        {
            public Navigation ClassOwner;

            public _Navigation(Navigation node)
            {
                ClassOwner = node;

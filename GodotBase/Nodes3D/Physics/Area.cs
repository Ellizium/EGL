...
namespace EGL.GodotBase.Nodes3D.Physics
{
    public class Area : INode
    {
        ...
        //Area
        public event Action<Godot.Area> AreaEntered;
        public event Action<Godot.Area> AreaExited;
        public event Action<int, Godot.Area, int, int> AreaShapeEntered;
        public event Action<int, Godot.Area, int, int> AreaShapeExited;
        ...
        protected class _Area : Godot.Area
        {
            ...
            {
                ClassOwner.AreaShapeEntered?.Invoke(areaId, area, areaShapeId, selfShapeId);
            }
            private void AreaShapeExited(int areaId, Godot.Area area, int areaShapeId, int selfShapeId)
            {
                ClassOwner.AreaShapeExited?.Invoke(areaId, area, areaShapeId, selfShapeId);
            }
            ...
            {
                ClassOwner.BodyShapeEntered?.Invoke(areaId, body, bodyShapeId, selfShapeId);
            }
            private void BodyShapeExited(int areaId, Godot.Node body, int bodyShapeId, int selfShapeId)
            {
                ClassOwner.BodyShapeExited?.Invoke(areaId, body, bodyShapeId, selfShapeId);
            }
            #endregion
        }
    }

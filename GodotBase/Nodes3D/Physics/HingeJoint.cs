...
namespace EGL.GodotBase.Nodes3D.Physics
{
    public class HingeJoint : INode
    {
        ...
        public Godot.HingeJoint Base { get; }

        public HingeJoint()
        {
            Base = new _HingeJoint(this);
        }

        protected class _HingeJoint : Godot.HingeJoint
        {
            public HingeJoint ClassOwner;

            public _HingeJoint(HingeJoint node)
            {
                ClassOwner = node;

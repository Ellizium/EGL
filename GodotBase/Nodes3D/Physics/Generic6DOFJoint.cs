...
{
    public class Generic6DOFJoint : INode
    {
        ...
        public Godot.Generic6DOFJoint Base { get; }

        public Generic6DOFJoint()
        {
            Base = new _Generic6DOFJoint(this);
        }

        protected class _Generic6DOFJoint : Godot.Generic6DOFJoint
        {
            public Generic6DOFJoint ClassOwner;

            public _Generic6DOFJoint(Generic6DOFJoint node)
            {
                ClassOwner = node;

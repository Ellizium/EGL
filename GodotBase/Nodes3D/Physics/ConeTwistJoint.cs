...
{
    public class ConeTwistJoint : INode
    {
        ...
        public Godot.ConeTwistJoint Base { get; }

        public ConeTwistJoint()
        {
            Base = new _ConeTwistJoint(this);
        }

        protected class _ConeTwistJoint : Godot.ConeTwistJoint
        {
            public ConeTwistJoint ClassOwner;

            public _ConeTwistJoint(ConeTwistJoint node)
            {
                ClassOwner = node;

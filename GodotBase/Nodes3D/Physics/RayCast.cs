...
namespace EGL.GodotBase.Nodes3D.Physics
{
    public class RayCast : INode
    {
        ...
        public Godot.RayCast Base { get; }

        public RayCast()
        {
            Base = new _RayCast(this);
        }

        protected class _RayCast : Godot.RayCast
        {
            public RayCast ClassOwner;

            public _RayCast(RayCast node)
            {
                ClassOwner = node;

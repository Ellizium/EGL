...
namespace EGL.GodotBase.Nodes3D.Physics
{
    public class PinJoint : INode
    {
        ...
        public Godot.PinJoint Base { get; }

        public PinJoint()
        {
            Base = new _PinJoint(this);
        }

        protected class _PinJoint : Godot.PinJoint
        {
            public PinJoint ClassOwner;

            public _PinJoint(PinJoint node)
            {
                ClassOwner = node;

...
{
    public class SliderJoint : INode
    {
        ...
        public Godot.SliderJoint Base { get; }

        public SliderJoint()
        {
            Base = new _SliderJoint(this);
        }

        protected class _SliderJoint : Godot.SliderJoint
        {
            public SliderJoint ClassOwner;

            public _SliderJoint(SliderJoint node)
            {
                ClassOwner = node;

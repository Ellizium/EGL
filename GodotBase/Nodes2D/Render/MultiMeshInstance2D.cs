...
namespace EGL.GodotBase.Nodes2D.Render
{
    public class MultiMeshInstance2D : INode
    {
        ...
        public Godot.MultiMeshInstance2D Base { get; }

        public MultiMeshInstance2D()
        {
            Base = new _MultiMeshInstance2D(this);
        }

        private class _MultiMeshInstance2D : Godot.MultiMeshInstance2D
        {
            public MultiMeshInstance2D ClassOwner;

            public _MultiMeshInstance2D(MultiMeshInstance2D node)
            {
                ClassOwner = node;
                ...
                //MultiMeshInstance2D
                Connect("texture_changed", this, nameof(TextureChanged));
            }
            ...
            #region MultiMeshInstance2D
            private void TextureChanged()
            {
                ClassOwner.TextureChanged?.Invoke();
            }
            #endregion
        }

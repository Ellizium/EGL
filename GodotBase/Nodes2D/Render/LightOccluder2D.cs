...
{
    public class LightOccluder2D : INode
    {
        ...
        public Godot.LightOccluder2D Base { get; }

        public LightOccluder2D()
        {
            Base = new _LightOccluder2D(this);
        }

        private class _LightOccluder2D : Godot.LightOccluder2D
        {
            public LightOccluder2D ClassOwner;

            public _LightOccluder2D(LightOccluder2D node)
            {
                ClassOwner = node;

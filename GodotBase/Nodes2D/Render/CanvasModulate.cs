...
{
    public class CanvasModulate : INode
    {
        ...
        public Godot.CanvasModulate Base { get; }

        public CanvasModulate()
        {
            Base = new _CanvasModulate(this);
        }

        private class _CanvasModulate : Godot.CanvasModulate
        {
            public CanvasModulate ClassOwner;

            public _CanvasModulate(CanvasModulate node)
            {
                ClassOwner = node;

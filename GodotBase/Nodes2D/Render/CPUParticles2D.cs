...
{
    public class CPUParticles2D : INode
    {
        ...
        public Godot.CPUParticles2D Base { get; }

        public CPUParticles2D()
        {
            Base = new _CPUParticles2D(this);
        }

        private class _CPUParticles2D : Godot.CPUParticles2D
        {
            public CPUParticles2D ClassOwner;

            public _CPUParticles2D(CPUParticles2D node)
            {
                ClassOwner = node;

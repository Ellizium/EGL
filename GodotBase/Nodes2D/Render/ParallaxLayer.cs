...
{
    public class ParallaxLayer : INode
    {
        ...
        public Godot.ParallaxLayer Base { get; }

        public ParallaxLayer()
        {
            Base = new _ParallaxLayer(this);
        }

        private class _ParallaxLayer : Godot.ParallaxLayer
        {
            public ParallaxLayer ClassOwner;

            public _ParallaxLayer(ParallaxLayer node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.Nodes2D.Render
{
    public class Skeleton2D : INode
    {
        ...
        public Godot.Skeleton2D Base { get; }

        public Skeleton2D()
        {
            Base = new _Skeleton2D(this);
        }

        private class _Skeleton2D : Godot.Skeleton2D
        {
            public Skeleton2D ClassOwner;

            public _Skeleton2D(Skeleton2D node)
            {
                ClassOwner = node;
                ...
                //Skeleton2D
                Connect("bone_setup_changed", this, nameof(BoneSetupChanged));
            }
            ...
            #region Skeleton2D
            private void BoneSetupChanged()
            {
                ClassOwner.BoneSetupChanged?.Invoke();
            }
            #endregion
        }
    }

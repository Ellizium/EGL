...
namespace EGL.GodotBase.Nodes2D.Render
{
    public class AnimatedSprite : INode
    {
        ...
        public Godot.AnimatedSprite Base { get; }

        private class _AnimatedSprite : Godot.AnimatedSprite
        {
            public AnimatedSprite ClassOwner;

            public _AnimatedSprite(AnimatedSprite node)
            {
                ClassOwner = node;
            ...
            {
                ClassOwner.AnimationFinished?.Invoke();
            }
            #endregion
        }
    }

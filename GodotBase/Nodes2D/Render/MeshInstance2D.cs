...
{
    public class MeshInstance2D : INode
    {
        ...
        public Godot.MeshInstance2D Base { get; }

        public MeshInstance2D()
        {
            Base = new _MeshInstance2D(this);
        }

        private class _MeshInstance2D : Godot.MeshInstance2D
        {
            public MeshInstance2D ClassOwner;

            public _MeshInstance2D(MeshInstance2D node)
            {
                ClassOwner = node;

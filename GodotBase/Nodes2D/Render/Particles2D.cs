...
{
    public class Particles2D : INode
    {
        ...
        public Godot.Particles2D Base { get; }

        public Particles2D()
        {
            Base = new _Particles2D(this);
        }

        private class _Particles2D : Godot.Particles2D
        {
            public Particles2D ClassOwner;

            public _Particles2D(Particles2D node)
            {
                ClassOwner = node;

...
{
    public class DampedSpringJoint2D : INode
    {
        ...
        public Godot.DampedSpringJoint2D Base { get; }

        public DampedSpringJoint2D()
        {
            Base = new _DampedSpringJoint2D(this);
        }

        private class _DampedSpringJoint2D : Godot.DampedSpringJoint2D
        {
            public DampedSpringJoint2D ClassOwner;

            public _DampedSpringJoint2D(DampedSpringJoint2D node)
            {
                ClassOwner = node;

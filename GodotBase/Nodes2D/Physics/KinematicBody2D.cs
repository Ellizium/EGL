...
{
    public class KinematicBody2D : INode
    {
        ...
        public Godot.KinematicBody2D Base { get; }

        public KinematicBody2D()
        {
            Base = new _KinematicBody2D(this);
        }

        private class _KinematicBody2D : Godot.KinematicBody2D
        {
            public KinematicBody2D ClassOwner;

            public _KinematicBody2D(KinematicBody2D node)
            {
                ClassOwner = node;

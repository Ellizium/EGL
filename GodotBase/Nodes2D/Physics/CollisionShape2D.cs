...
{
    public class CollisionShape2D : INode
    {
        ...
        public Godot.CollisionShape2D Base { get; }

        public CollisionShape2D()
        {
            Base = new _CollisionShape2D(this);
        }

        private class _CollisionShape2D : Godot.CollisionShape2D
        {
            public CollisionShape2D ClassOwner;

            public _CollisionShape2D(CollisionShape2D node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.Nodes2D.Physics
{
    public class RayCast2D : INode
    {
        ...
        public Godot.RayCast2D Base { get; }

        public RayCast2D()
        {
            Base = new _RayCast2D(this);
        }

        private class _RayCast2D : Godot.RayCast2D
        {
            public RayCast2D ClassOwner;

            public _RayCast2D(RayCast2D node)
            {
                ClassOwner = node;

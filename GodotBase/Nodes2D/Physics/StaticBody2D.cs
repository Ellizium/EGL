...
{
    public class StaticBody2D : INode
    {
        ...
        public Action DrawProcess = null;
        ...
        public Godot.StaticBody2D Base { get; }

        public StaticBody2D()
        {
            Base = new _StaticBody2D(this);
        }

        private class _StaticBody2D : Godot.StaticBody2D
        {
            public StaticBody2D ClassOwner;

            public _StaticBody2D(StaticBody2D node)
            {
                ClassOwner = node;

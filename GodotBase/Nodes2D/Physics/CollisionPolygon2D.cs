...
{
    public class CollisionPolygon2D : INode
    {
        ...
        public Godot.CollisionPolygon2D Base { get; }

        public CollisionPolygon2D()
        {
            Base = new _CollisionPolygon2D(this);
        }

        private class _CollisionPolygon2D : Godot.CollisionPolygon2D
        {
            public CollisionPolygon2D ClassOwner;

            public _CollisionPolygon2D(CollisionPolygon2D node)
            {
                ClassOwner = node;

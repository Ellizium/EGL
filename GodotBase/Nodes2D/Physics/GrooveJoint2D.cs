...
{
    public class GrooveJoint2D : INode
    {
        ...
        public Godot.GrooveJoint2D Base { get; }

        public GrooveJoint2D()
        {
            Base = new _GrooveJoint2D(this);
        }

        private class _GrooveJoint2D : Godot.GrooveJoint2D
        {
            public GrooveJoint2D ClassOwner;

            public _GrooveJoint2D(GrooveJoint2D node)
            {
                ClassOwner = node;

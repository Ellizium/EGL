...
namespace EGL.GodotBase.Nodes2D.Physics
{
    public class PinJoint2D : INode
    {
        ...
        public Godot.PinJoint2D Base { get; }

        public PinJoint2D()
        {
            Base = new _PinJoint2D(this);
        }

        private class _PinJoint2D : Godot.PinJoint2D
        {
            public PinJoint2D ClassOwner;

            public _PinJoint2D(PinJoint2D node)
            {
                ClassOwner = node;

...
{
    public class BackBufferCopy : INode
    {
        ...
        public Godot.BackBufferCopy Base { get; }

        public BackBufferCopy()
        {
            Base = new _BackBufferCopy(this);
        }

        private class _BackBufferCopy : Godot.BackBufferCopy
        {
            public BackBufferCopy ClassOwner;

            public _BackBufferCopy(BackBufferCopy node)
            {
                ClassOwner = node;

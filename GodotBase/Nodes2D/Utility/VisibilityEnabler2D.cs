...
{
    public class VisibilityEnabler2D : INode
    {
        ...
        public Godot.VisibilityEnabler2D Base { get; }

        public VisibilityEnabler2D()
        {
            Base = new _VisibilityEnabler2D(this);
        }

        private class _VisibilityEnabler2D : Godot.VisibilityEnabler2D
        {
            public VisibilityEnabler2D ClassOwner;

            public _VisibilityEnabler2D(VisibilityEnabler2D node)
            {
                ClassOwner = node;

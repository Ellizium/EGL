...
{
    public class PathFollow2D : INode
    {
        ...
        public Godot.PathFollow2D Base { get; }

        public PathFollow2D()
        {
            Base = new _PathFollow2D(this);
        }

        private class _PathFollow2D : Godot.PathFollow2D
        {
            public PathFollow2D ClassOwner;

            public _PathFollow2D(PathFollow2D node)
            {
                ClassOwner = node;

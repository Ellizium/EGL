...
{
    public class Navigation2D : INode
    {
        ...
        public Godot.Navigation2D Base { get; }

        public Navigation2D()
        {
            Base = new _Navigation2D(this);
        }

        private class _Navigation2D : Godot.Navigation2D
        {
            public Navigation2D ClassOwner;

            public _Navigation2D(Navigation2D node)
            {
                ClassOwner = node;

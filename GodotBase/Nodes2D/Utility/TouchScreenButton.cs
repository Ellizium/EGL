...
{
    public class TouchScreenButton : INode
    {
        ...
        public Godot.TouchScreenButton Base { get; }

        public TouchScreenButton()
        {
            Base = new _TouchScreenButton(this);
        }

        private class _TouchScreenButton : Godot.TouchScreenButton
        {
            public TouchScreenButton ClassOwner;

            public _TouchScreenButton(TouchScreenButton node)
            {
                ClassOwner = node;
                ...
                Connect("released", this, nameof(Released));
            }

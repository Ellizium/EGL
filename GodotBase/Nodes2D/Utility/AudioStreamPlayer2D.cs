...
{
    public class AudioStreamPlayer2D : INode
    {
        ...
        public Godot.AudioStreamPlayer2D Base { get; }

        public AudioStreamPlayer2D()
        {
            Base = new _AudioStreamPlayer2D(this);
        }

        private class _AudioStreamPlayer2D : Godot.AudioStreamPlayer2D
        {
            public AudioStreamPlayer2D ClassOwner;

            public _AudioStreamPlayer2D(AudioStreamPlayer2D node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.Nodes2D.Utility
{
    public class YSort : INode
    {
        ...
        public Godot.YSort Base { get; }

        public YSort()
        {
            Base = new _YSort(this);
        }

        private class _YSort : Godot.YSort
        {
            public YSort ClassOwner;

            public _YSort(YSort node)
            {
                ClassOwner = node;

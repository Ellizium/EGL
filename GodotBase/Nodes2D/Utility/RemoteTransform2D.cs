...
{
    public class RemoteTransform2D : INode
    {
        ...
        public Godot.RemoteTransform2D Base { get; }

        public RemoteTransform2D()
        {
            Base = new _RemoteTransform2D(this);
        }

        private class _RemoteTransform2D : Godot.RemoteTransform2D
        {
            public RemoteTransform2D ClassOwner;

            public _RemoteTransform2D(RemoteTransform2D node)
            {
                ClassOwner = node;

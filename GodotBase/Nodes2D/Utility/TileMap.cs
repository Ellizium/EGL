...
namespace EGL.GodotBase.Nodes2D.Utility
{
    public class TileMap : INode
    {
        ...
        public Godot.TileMap Base { get; }

        public TileMap()
        {
            Base = new _TileMap(this);
        }

        private class _TileMap : Godot.TileMap
        {
            public TileMap ClassOwner;

            public _TileMap(TileMap node)
            {
                ClassOwner = node;
                ...
                //TileMap
                Connect("settings_changed", this, nameof(SettingsChanged));
            ...
            {
                ClassOwner.SettingsChanged?.Invoke();
            }
            #endregion
        }
    }

...
{
    public class NavigationPolygonInstance : INode
    {
        ...
        public Godot.NavigationPolygonInstance Base { get; }

        public NavigationPolygonInstance()
        {
            Base = new _NavigationPolygonInstance(this);
        }

        private class _NavigationPolygonInstance : Godot.NavigationPolygonInstance
        {
            public NavigationPolygonInstance ClassOwner;

            public _NavigationPolygonInstance(NavigationPolygonInstance node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.GUI
{
    public class VSlider : INode
    {
        ...
        public Godot.VSlider Base { get; }

        public VSlider()
        {
            Base = new _VSlider(this);
        }

        protected class _VSlider : Godot.VSlider
        {
            public VSlider ClassOwner;

            public _VSlider(VSlider node)
            {
                ClassOwner = node;

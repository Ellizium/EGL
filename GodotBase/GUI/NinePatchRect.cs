...
{
    public class NinePatchRect : INode
    {
        ...
        public Godot.NinePatchRect Base { get; }

        public NinePatchRect()
        {
            Base = new _NinePatchRect(this);
        }

        protected class _NinePatchRect : Godot.NinePatchRect
        {
            public NinePatchRect ClassOwner;

            public _NinePatchRect(NinePatchRect node)
            {
                ClassOwner = node;

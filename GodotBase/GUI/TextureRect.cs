...
{
    public class TextureRect : INode
    {
        ...
        public Godot.TextureRect Base { get; }

        public TextureRect()
        {
            Base = new _TextureRect(this);
        }

        protected class _TextureRect : Godot.TextureRect
        {
            public TextureRect ClassOwner;

            public _TextureRect(TextureRect node)
            {
                ClassOwner = node;

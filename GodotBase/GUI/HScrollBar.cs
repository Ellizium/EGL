...
namespace EGL.GodotBase.GUI
{
    public class HScrollBar : INode
    {
        ...
        public Godot.HScrollBar Base { get; }

        public HScrollBar()
        {
            Base = new _HScrollBar(this);
        }

        protected class _HScrollBar : Godot.HScrollBar
        {
            public HScrollBar ClassOwner;

            public _HScrollBar(HScrollBar node)
            {
                ClassOwner = node;

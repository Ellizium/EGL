...
{
    public class TextureProgress : INode
    {
        ...
        public Godot.TextureProgress Base { get; }

        public TextureProgress()
        {
            Base = new _TextureProgress(this);
        }

        protected class _TextureProgress : Godot.TextureProgress
        {
            public TextureProgress ClassOwner;

            public _TextureProgress(TextureProgress node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.GUI.Separators
{
    public class HSeparator : INode
    {
        ...
        public Godot.HSeparator Base { get; }

        public HSeparator()
        {
            Base = new _HSeparator(this);
        }

        protected class _HSeparator : Godot.HSeparator
        {
            public HSeparator ClassOwner;

            public _HSeparator(HSeparator node)
            {
                ClassOwner = node;

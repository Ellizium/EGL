...
namespace EGL.GodotBase.GUI.Separators
{
    public class VSeparator : INode
    {
        ...
        public Godot.VSeparator Base { get; }

        public VSeparator()
        {
            Base = new _VSeparator(this);
        }

        protected class _VSeparator : Godot.VSeparator
        {
            public VSeparator ClassOwner;

            public _VSeparator(VSeparator node)
            {
                ClassOwner = node;

...
{
    public class ReferenceRect : INode
    {
        ...
        public Godot.ReferenceRect Base { get; }

        public ReferenceRect()
        {
            Base = new _ReferenceRect(this);
        }

        protected class _ReferenceRect : Godot.ReferenceRect
        {
            public ReferenceRect ClassOwner;

            public _ReferenceRect(ReferenceRect node)
            {
                ClassOwner = node;

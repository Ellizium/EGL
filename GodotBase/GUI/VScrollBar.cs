...
namespace EGL.GodotBase.GUI
{
    public class VScrollBar : INode
    {
        ...
        public Godot.VScrollBar Base { get; }

        public VScrollBar()
        {
            Base = new _VScrollBar(this);
        }

        protected class _VScrollBar : Godot.VScrollBar
        {
            public VScrollBar ClassOwner;

            public _VScrollBar(VScrollBar node)
            {
                ClassOwner = node;
                ...
                //Range
                Connect("changed", this, nameof(Changed));
                Connect("value_changed", this, nameof(ValueChanged));

                //HScrollBar
                Connect("scrolling", this, nameof(Scrolling));
            }
            ...
            {
                ClassOwner.Changed?.Invoke();
            }
            private void ValueChanged(float value)
            {
                ClassOwner.ValueChanged?.Invoke(value);
            }
            #endregion

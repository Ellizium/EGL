...
namespace EGL.GodotBase.GUI
{
    public class HSlider : INode
    {
        ...
        public Godot.HSlider Base { get; }

        public HSlider()
        {
            Base = new _HSlider(this);
        }

        protected class _HSlider : Godot.HSlider
        {
            public HSlider ClassOwner;

            public _HSlider(HSlider node)
            {
                ClassOwner = node;

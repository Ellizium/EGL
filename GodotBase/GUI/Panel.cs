...
namespace EGL.GodotBase.GUI
{
    public class Panel : INode
    {
        ...
        public Godot.Panel Base { get; }

        public Panel()
        {
            Base = new _Panel(this);
        }

        protected class _Panel : Godot.Panel
        {
            public Panel ClassOwner;

            public _Panel(Panel node)
            {
                ClassOwner = node;

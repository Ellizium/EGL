...
{
    public class ProgressBar : INode
    {
        ...
        public Godot.ProgressBar Base { get; }

        public ProgressBar()
        {
            Base = new _ProgressBar(this);
        }

        protected class _ProgressBar : Godot.ProgressBar
        {
            public ProgressBar ClassOwner;

            public _ProgressBar(ProgressBar node)
            {
                ClassOwner = node;

...
{
    public class VideoPlayer : INode
    {
        ...
        public Godot.VideoPlayer Base { get; }

        public VideoPlayer()
        {
            Base = new _VideoPlayer(this);
        }

        protected class _VideoPlayer : Godot.VideoPlayer
        {
            public VideoPlayer ClassOwner;

            public _VideoPlayer(VideoPlayer node)
            {
                ClassOwner = node;

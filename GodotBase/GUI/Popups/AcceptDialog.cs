...
{
    public class AcceptDialog : INode
    {
        ...
        public Godot.AcceptDialog Base { get; }

        public AcceptDialog()
        {
            Base = new _AcceptDialog(this);
        }

        protected class _AcceptDialog : Godot.AcceptDialog
        {
            public AcceptDialog ClassOwner;

            public _AcceptDialog(AcceptDialog node)
            {
                ClassOwner = node;

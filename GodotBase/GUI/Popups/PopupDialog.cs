...
{
    public class PopupDialog : INode
    {
        ...
        public Godot.PopupDialog Base { get; }

        public PopupDialog()
        {
            Base = new _PopupDialog(this);
        }

        protected class _PopupDialog : Godot.PopupDialog
        {
            public PopupDialog ClassOwner;

            public _PopupDialog(PopupDialog node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.GUI.Popups
{
    public class PopupMenu : INode
    {
        ...
        public Godot.PopupMenu Base { get; }

        public PopupMenu()
        {
            Base = new _PopupMenu(this);
        }

        protected class _PopupMenu : Godot.PopupMenu
        {
            public PopupMenu ClassOwner;

            public _PopupMenu(PopupMenu node)
            {
                ClassOwner = node;
                ...
                //PopupMenu
                Connect("id_focused", this, nameof(IdFocused));
                Connect("id_pressed", this, nameof(IdPressed));
                Connect("index_pressed", this, nameof(IndexPressed));
            }
            ...
            #region PopupMenu
            private void IdFocused(int id)
            {
                ClassOwner.IdFocused?.Invoke(id);
            }
            private void IdPressed(int id)
            {
                ClassOwner.IdPressed?.Invoke(id);
            }
            private void IndexPressed(int index)
            {
                ClassOwner.IndexPressed?.Invoke(index);
            }
            #endregion
        }
    }

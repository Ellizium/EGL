...
{
    public class ConfirmationDialog : INode
    {
        ...
        public Godot.ConfirmationDialog Base { get; }

        public ConfirmationDialog()
        {
            Base = new _ConfirmationDialog(this);
        }

        protected class _ConfirmationDialog : Godot.ConfirmationDialog
        {
            public ConfirmationDialog ClassOwner;

            public _ConfirmationDialog(ConfirmationDialog node)
            {
                ClassOwner = node;

...
{
    public class WindowDialog : INode
    {
        ...
        public Godot.WindowDialog Base { get; }
        ...
        protected class _WindowDialog : Godot.WindowDialog
        {
            public WindowDialog ClassOwner;

            public _WindowDialog(WindowDialog node)
            {
                ClassOwner = node;

...
namespace EGL.GodotBase.GUI
{
    public class ColorRect : INode
    {
        ...
        public Godot.ColorRect Base { get; }

        public ColorRect()
        {
            Base = new _ColorRect(this);
        }

        protected class _ColorRect : Godot.ColorRect
        {
            public ColorRect ClassOwner;

            public _ColorRect(ColorRect node)
            {
                ClassOwner = node;

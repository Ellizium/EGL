...
namespace EGL.GodotBase.GUI
{
    public class SpinBox : INode
    {
        ...
        public Godot.SpinBox Base { get; }

        public SpinBox()
        {
            Base = new _SpinBox(this);
        }

        protected class _SpinBox : Godot.SpinBox
        {
            public SpinBox ClassOwner;

            public _SpinBox(SpinBox node)
            {
                ClassOwner = node;

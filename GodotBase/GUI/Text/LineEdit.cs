...
namespace EGL.GodotBase.GUI.Text
{
    public class LineEdit : INode
    {
        ...
        //LineEdit
        public event Action TextChangeRejected;
        public event Action<string> TextChanged;
        public event Action<string> TextEntered;

        public Godot.LineEdit Base { get; }
        ...
        protected class _LineEdit : Godot.LineEdit
        {
            public LineEdit ClassOwner;

            public _LineEdit(LineEdit node)
            {
                ClassOwner = node;
                ...
                //LineEdit
                Connect("text_change_rejected", this, nameof(TextChangeRejected));
                Connect("text_changed", this, nameof(TextChanged));
                Connect("text_entered", this, nameof(TextEntered));
            }
            ...
            #region LineEdit
            private void TextChangeRejected() 
            {
                ClassOwner.TextChangeRejected?.Invoke();
            }
            private void TextChanged(string str)
            {
                ClassOwner.TextChanged?.Invoke(str);
            }
            private void TextEntered(string str)
            {
                ClassOwner.TextEntered?.Invoke(str);
            }
            #endregion
        }
    }

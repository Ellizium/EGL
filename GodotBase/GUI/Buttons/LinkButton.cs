...
namespace EGL.GodotBase.GUI.Buttons
{
    public class LinkButton : INode
    {
        ...
        public Godot.LinkButton Base { get; }

        public LinkButton()
        {
            Base = new _LinkButton(this);
        }

        protected class _LinkButton : Godot.LinkButton
        {
            public LinkButton ClassOwner;

            public _LinkButton(LinkButton node)
            {
                ClassOwner = node;

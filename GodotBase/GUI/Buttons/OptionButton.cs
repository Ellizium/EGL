...
{
    public class OptionButton : INode
    {
        ...
        public Godot.OptionButton Base { get; }

        public OptionButton()
        {
            Base = new _OptionButton(this);
        }

        protected class _OptionButton : Godot.OptionButton
        {
            public OptionButton ClassOwner;

            public _OptionButton(OptionButton node)
            {
                ClassOwner = node;
                ...
                //OptionButton
                Connect("item_focused", this, nameof(ItemFocused));
            ...
            #region OptionButton
            private void ItemFocused(int index)
            {
                ClassOwner.ItemFocused?.Invoke(index);
            }
            private void ItemSelected(int index)
            {
                ClassOwner.ItemSelected?.Invoke(index);
            }
            #endregion
        }
    }

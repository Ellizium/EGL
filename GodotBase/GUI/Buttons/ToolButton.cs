...
namespace EGL.GodotBase.GUI.Buttons
{
    public class ToolButton : INode
    {
        ...
        public Godot.ToolButton Base { get; }

        public ToolButton()
        {
            Base = new _ToolButton(this);
        }

        protected class _ToolButton : Godot.ToolButton
        {
            public ToolButton ClassOwner;

            public _ToolButton(ToolButton node)
            {
                ClassOwner = node;

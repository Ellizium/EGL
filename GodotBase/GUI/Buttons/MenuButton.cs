...
namespace EGL.GodotBase.GUI.Buttons
{
    public class MenuButton : INode
    {
        ...
        public Godot.MenuButton Base { get; }

        public MenuButton()
        {
            Base = new _MenuButton(this);
        }

        protected class _MenuButton : Godot.MenuButton
        {
            public MenuButton ClassOwner;

            public _MenuButton(MenuButton node)
            {
                ClassOwner = node;

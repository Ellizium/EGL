...
{
    public class TextureButton : INode
    {
        ...
        public Godot.TextureButton Base { get; }

        public TextureButton()
        {
            Base = new _TextureButton(this);
        }

        protected class _TextureButton : Godot.TextureButton
        {
            public TextureButton ClassOwner;

            public _TextureButton(TextureButton node)
            {
                ClassOwner = node;

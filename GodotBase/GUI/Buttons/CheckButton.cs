...
{
    public class CheckButton : INode
    {
        ...
        public Godot.CheckButton Base { get; }

        public CheckButton()
        {
            Base = new _CheckButton(this);
        }

        protected class _CheckButton : Godot.CheckButton
        {
            public CheckButton ClassOwner;

            public _CheckButton(CheckButton node)
            {
                ClassOwner = node;

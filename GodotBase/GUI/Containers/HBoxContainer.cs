...
{
    public class HBoxContainer : INode
    {
        ...
        public Godot.HBoxContainer Base { get; }

        public HBoxContainer()
        {
            Base = new _HBoxContainer(this);
        }

        protected class _HBoxContainer : Godot.HBoxContainer
        {
            public HBoxContainer ClassOwner;

            public _HBoxContainer(HBoxContainer node)
            {
                ClassOwner = node;

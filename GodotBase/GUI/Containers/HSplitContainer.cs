...
{
    public class HSplitContainer : INode
    {
        ...
        public Godot.HSplitContainer Base { get; }

        public HSplitContainer()
        {
            Base = new _HSplitContainer(this);
        }

        protected class _HSplitContainer : Godot.HSplitContainer
        {
            public HSplitContainer ClassOwner;

            public _HSplitContainer(HSplitContainer node)
            {
                ClassOwner = node;

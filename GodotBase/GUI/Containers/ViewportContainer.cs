...
{
    public class ViewportContainer : INode
    {
        ...
        public Godot.ViewportContainer Base { get; }

        public ViewportContainer()
        {
            Base = new _ViewportContainer(this);
        }

        protected class _ViewportContainer : Godot.ViewportContainer
        {
            public ViewportContainer ClassOwner;

            public _ViewportContainer(ViewportContainer node)
            {
                ClassOwner = node;

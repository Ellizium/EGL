...
namespace EGL.GodotBase.GUI.Containers
{
    public class Container : INode
    {
        ...
        public Godot.Container Base { get; }

        public Container()
        {
            Base = new _Container(this);
        }

        protected class _Container : Godot.Container
        {
            public Container ClassOwner;

            public _Container(Container node)
            {
                ClassOwner = node;

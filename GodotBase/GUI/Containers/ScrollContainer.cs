...
{
    public class ScrollContainer : INode
    {
        ...
        public Godot.ScrollContainer Base { get; }

        public ScrollContainer()
        {
            Base = new _ScrollContainer(this);
        }

        protected class _ScrollContainer : Godot.ScrollContainer
        {
            public ScrollContainer ClassOwner;

            public _ScrollContainer(ScrollContainer node)
            {
                ClassOwner = node;
                ...
                //ScrollContainer
                Connect("scroll_ended", this, nameof(ScrollEnded));
                Connect("scroll_started", this, nameof(ScrollStarted));
            }
            ...
            {
                ClassOwner.ScrollEnded?.Invoke();
            }
            private void ScrollStarted()
            {
                ClassOwner.ScrollStarted?.Invoke();
            }
            #endregion
        }
    }

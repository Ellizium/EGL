...
{
    public class MarginContainer : INode
    {
        ...
        public Godot.MarginContainer Base { get; }

        public MarginContainer()
        {
            Base = new _MarginContainer(this);
        }

        protected class _MarginContainer : Godot.MarginContainer
        {
            public MarginContainer ClassOwner;

            public _MarginContainer(MarginContainer node)
            {
                ClassOwner = node;

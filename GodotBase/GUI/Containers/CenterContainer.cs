...
{
    public class CenterContainer : INode
    {
        ...
        public Godot.CenterContainer Base { get; }

        public CenterContainer()
        {
            Base = new _CenterContainer(this);
        }

        protected class _CenterContainer : Godot.CenterContainer
        {
            public CenterContainer ClassOwner;

            public _CenterContainer(CenterContainer node)
            {
                ClassOwner = node;

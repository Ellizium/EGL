...
{
    public class ColorPicker : INode
    {
        ...
        public event Action<Godot.Color> PresetAdded;
        public event Action<Godot.Color> PresetRemoved;

        public Godot.ColorPicker Base { get; }

        public ColorPicker()
        {
            Base = new _ColorPicker(this);
        }

        protected class _ColorPicker : Godot.ColorPicker
        {
            public ColorPicker ClassOwner;

            public _ColorPicker(ColorPicker node)
            {
                ClassOwner = node;
                ...
                Connect("preset_added", this, nameof(PresetAdded));
                Connect("preset_removed", this, nameof(PresetRemove));
            }
            ...
            private void PresetAdded(Godot.Color color)
            {
                ClassOwner.PresetAdded?.Invoke(color);
            }
            private void PresetRemove(Godot.Color color)
            {
                ClassOwner.PresetRemoved?.Invoke(color);
            }
            #endregion
        }
    }

...
{
    public class VBoxContainer : INode
    {
        ...
        public Godot.VBoxContainer Base { get; }
        ...
        protected class _VBoxContainer : Godot.VBoxContainer
        {
            public VBoxContainer ClassOwner;

            public _VBoxContainer(VBoxContainer node)
            {
                ClassOwner = node;

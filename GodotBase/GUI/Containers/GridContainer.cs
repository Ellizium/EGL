...
{
    public class GridContainer : INode
    {
        ...
        public Godot.GridContainer Base { get; }
        ...
        protected class _GridContainer : Godot.GridContainer
        {
            public GridContainer ClassOwner;

            public _GridContainer(GridContainer node)
            {
                ClassOwner = node;

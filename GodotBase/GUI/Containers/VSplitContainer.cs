...
{
    public class VSplitContainer : INode
    {
        ...
        public Godot.VSplitContainer Base { get; }

        public VSplitContainer()
        {
            Base = new _VSplitContainer(this);
        }

        protected class _VSplitContainer : Godot.VSplitContainer
        {
            public VSplitContainer ClassOwner;

            public _VSplitContainer(VSplitContainer node)
            {
                ClassOwner = node;
            ...
            #region HSplitContainer
            private void Dragged(int offset)
            {
                ClassOwner.Dragged?.Invoke(offset);
            }
            #endregion
        }
    }

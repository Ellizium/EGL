...
{
    public class TabContainer : INode
    {
        ...
        public Godot.TabContainer Base { get; }

        public TabContainer()
        {
            Base = new _TabContainer(this);
        }

        protected class _TabContainer : Godot.TabContainer
        {
            public TabContainer ClassOwner;

            public _TabContainer(TabContainer node)
            {
                ClassOwner = node;
                ...
                //TabContainer
                Connect("pre_popup_pressed", this, nameof(PrePopupPressed));
                Connect("tab_changed", this, nameof(TabChanged));
                Connect("tab_selected", this, nameof(TabSelected));
            }
            ...
            #region TabContainer
            private void PrePopupPressed()
            {
                ClassOwner.PrePopupPressed?.Invoke();
            }
            ...
            {
                ClassOwner.TabSelected?.Invoke(tab);
            }
            #endregion
        }
    }
